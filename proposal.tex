...
\begin{table}[H]
    ...
    \begin{threeparttable}
        ...
        \begin{tablenotes}
            ...
            \]
            where $\delta_d$ are district fixed effects, and $\alpha_r$ are survey round fixed effects. Controls include prior neonatal death, projected maternal underweight, child sex, maternal age under 20, birth order, twins, wealth quintile, and maternal illiteracy.
...
\begin{itemize}
    \item There is no excess private neonatal mortality for forward caste Hindu births. 
    \item Excess private neonatal mortality is most for Dalit births, then Muslim births, then OBC births.
\end{itemize}
